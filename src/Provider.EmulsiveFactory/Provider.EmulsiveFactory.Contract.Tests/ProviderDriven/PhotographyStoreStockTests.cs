...
namespace Provider.EmulsiveFactory.Contract.Tests.ProviderDriven;
...
public class PhotographyStoreStockTests
{
    ...
    public void Setup()
    {
        ...
        {
            PactDir = PactUtils.ContractsLocation(ContractStrategy.ProviderDriven)
        });
        _pactBuilder = pact.WithHttpInteractions();
    }
    
    [Test(Description = "Provider Driven Contract Test")]
