...
## Troubleshooting
#### Trust the certificate generated by the C# service
- Browse to the the solution file
- Type `dotnet dev-certs https --trust`

#### Trust the certificate generated by the C# service
- In VSCode install the `C# Dev Kit` extension
- Open the folder containing the solution
- Open Command Palette and search for `.NET: Generate Assets for Build and Debug`
  - This will generate the .vscode folder and repopulate with build configuration.
